...
export type WorkerRuntimeConfig = Readonly<{
  ...
  jobs: Readonly<{
    ...
    hubspotHealthCheck: WorkerJobOptions;
...
export function getWorkerRuntimeConfig(
  ...
  return {
    ...
    jobs: {
      ...
      hubspotHealthCheck: buildWorkerJobOptions(
        env,
        "WORKER_HUBSPOT_HEALTH_CHECK_CONCURRENCY",
        1,
      ),
      hubspotObjectSyncSchedule: buildWorkerJobOptions(
        env,
        "WORKER_HUBSPOT_OBJECT_SYNC_SCHEDULE_CONCURRENCY",
        1,
      ),
