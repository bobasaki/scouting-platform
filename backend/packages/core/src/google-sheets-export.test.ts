...
import {
  ...
  enrichGoogleSheetsCreatorListRows,
...
describe("google sheets export core service", () => {
  beforeEach(() => {
    ...
    getHubspotExportPreviewMock.mockResolvedValue({
      ...
      columns: [
        ...
        {
          key: "youtubeVideoMedianViews",
          label: "YouTube Video Median Views",
          editable: false,
          required: false,
          fieldType: "text",
          dropdownFieldKey: null,
        ...
        {
          key: "youtubeShortsMedianViews",
          label: "YouTube Shorts Median Views",
          editable: false,
          required: false,
          fieldType: "text",
          dropdownFieldKey: null,
  ...
  it("fills blank Creator List cells in Google Sheets from matching HubSpot preview rows", () => {
    const result = enrichGoogleSheetsCreatorListRows({
      headerRow: [
        "Channel Name",
        "Campaign Name",
        "Email",
