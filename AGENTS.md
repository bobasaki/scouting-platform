...
**Quick start:** Read [`/docs/CODEX_QUICKREF.md`](./docs/CODEX_QUICKREF.md) first for the condensed rules.
...
1. [`/docs/CODEX_QUICKREF.md`](./docs/CODEX_QUICKREF.md) — condensed rules and checklists
2. [`/docs/TASKS.md`](./docs/TASKS.md) — current milestone and your assigned work
3. [`/docs/patterns/`](./docs/patterns/) — copy patterns for new code

For deeper context when needed:
- [`/docs/ARCHITECTURE.md`](./docs/ARCHITECTURE.md) — system design
- [`/docs/PROJECT_SPEC.md`](./docs/PROJECT_SPEC.md) — product scope
- [`/docs/`](./docs/) ADR files — architectural decisions
...
See [`/docs/CODEX_QUICKREF.md`](./docs/CODEX_QUICKREF.md) for the full table. Summary:
